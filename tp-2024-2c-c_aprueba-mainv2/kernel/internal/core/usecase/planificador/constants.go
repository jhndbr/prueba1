...
func VerificarSemaforos() {
	...
	valueR, _ := semR.GetValue()

	if valueREADY != 0 || valuePEXIT != 0 || valuePNEW != 0 || valuePLAN != 0 || valuePD != 0 || valueCF != 0 || valueINT != 0 || valueR != 0 {
		CerrarSemaforos()
